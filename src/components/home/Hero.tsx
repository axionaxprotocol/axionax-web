      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto animate-fade-in-up animation-delay-800">
            ...
            <div className="group text-center p-4 rounded-xl bg-dark-900/50 border border-dark-800 hover:border-amber-500/50 hover:bg-dark-900 transition-all duration-300 cursor-default">
