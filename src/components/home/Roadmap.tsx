  ...
  const roadmapPhases = [
    {
      phase: 'Q4 2025',
      status: 'completed',
      title: 'v1.6 Multi-Language Core',
      items: [
        'Rust core implementation (80%)',
        'Python ML layer with PyO3 (10%)',
        'TypeScript SDK (10%)',
    ...
    },
    {
      phase: 'Q1 2026',
      status: 'in-progress',
      title: 'v1.7 Network Layer',
      items: [
        'libp2p P2P networking (Current)',
    ...
    },
    {
      phase: 'Q2 2026',
      status: 'upcoming',
      title: 'v1.8 Public Testnet Launch',
      items: [
    ...
    },
    {
      phase: 'Q3 2026',
      status: 'upcoming',
      title: 'v1.9 Mainnet Preparation',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        'AI compute marketplace expansion',
