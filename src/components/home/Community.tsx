...
export default function Community(_props: Props) {
  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Discord icon" role="img">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Twitter icon" role="img">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="GitHub icon" role="img">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Telegram icon" role="img">
