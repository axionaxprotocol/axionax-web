  ...
  const docSections = [
    {
      ...
      items: [
        { name: 'Quick Start', href: `${DOCS_BASE}/QUICKSTART.html`, external: true },
        { name: 'Getting Started', href: `${DOCS_BASE}/GETTING_STARTED.html`, external: true },
        { name: 'Developer Guide', href: `${DOCS_BASE}/DEVELOPER_GUIDE.md`, external: true },
        { name: 'Chain ID Configuration', href: `${DOCS_BASE}/CHAIN_ID_CONFIGURATION.md`, external: true },
      ],
    },
    {
      title: 'Core Concepts',
      items: [
        { name: 'Architecture', href: `${DOCS_BASE}/ARCHITECTURE.html`, external: true },
        { name: 'API Reference', href: `${DOCS_BASE}/API_REFERENCE.html`, external: true },
        { name: 'State RPC Usage', href: `${DOCS_BASE}/STATE_RPC_USAGE.html`, external: true },
        { name: 'Tokenomics', href: `${DOCS_BASE}/TOKENOMICS.md`, external: true },
      ],
    },
    {
      title: 'Development',
      items: [
        { name: 'Build Guide', href: `${DOCS_BASE}/BUILD.html`, external: true },
        { name: 'Testing Guide', href: `${DOCS_BASE}/TESTING_GUIDE.md`, external: true },
        { name: 'Tutorials', href: `${DOCS_BASE}/TUTORIALS.md`, external: true },
        { name: 'SDK (TypeScript)', href: 'https://github.com/axionaxprotocol/axionax-sdk-ts', external: true },
      ],
    },
    {
      title: 'Deployment',
      items: [
        { name: 'Node Integration', href: `${DOCS_BASE}/NODE_INTEGRATION.html`, external: true },
        { name: 'Testnet Integration', href: `${DOCS_BASE}/TESTNET_INTEGRATION.html`, external: true },
        { name: 'VPS Validator Setup', href: `${DOCS_BASE}/VPS_VALIDATOR_SETUP.md`, external: true },
        { name: 'RPC Node Deployment', href: `${DOCS_BASE}/RPC_NODE_DEPLOYMENT.md`, external: true },
      ],
    },
  ];
...
const balance = await client.getBalance(wallet.address);`}</pre>
              ...
              <div className="mt-8 p-4 bg-primary-500/10 border border-primary-500/20 rounded-lg">
                <p className="text-primary-400 font-semibold mb-2">📚 Complete Documentation Available</p>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-primary-500/10 border border-primary-500/20 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-white">Testnet</span>
                    <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded-full">Coming Q1 2026</span>
                  </div>
                  <p className="text-xs text-dark-400">Chain ID: 86137</p>
                </div>
                <div className="p-3 bg-dark-800 border border-dark-700 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-white">Mainnet</span>
                    <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded-full">Q2 2026</span>
                  </div>
                  <p className="text-xs text-dark-400">Chain ID: 86150</p>
                </div>
                <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-white">Local Dev</span>
